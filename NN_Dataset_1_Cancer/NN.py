...
architectures = [
    {"layer_dims": [9, 16, 16, 16, 1], "activation": "relu"},
    {"layer_dims": [9, 16, 16, 1], "activation": "relu"},
    {"layer_dims": [9, 16, 1], "activation": "relu"},
    {"layer_dims": [9, 8, 1], "activation": "relu"},
    {"layer_dims": [9, 4, 1], "activation": "relu"},
    {"layer_dims": [9, 4, 1], "activation": "tanh"}
]
...
# Save the plot
plt.tight_layout()
plt.savefig("nn_architecture_metrics_dataset_1.png", dpi=300)  # Save as a PNG file
plt.show()
